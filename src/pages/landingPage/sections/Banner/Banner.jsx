  ...
  return (
    <div className="bg-base-100 py-16 mt-20">
      <div className="container mx-auto">
        <div className="flex flex-col-reverse md:flex-col-reverse lg:flex-row gap-10 lg:gap-24 justify-between px-14 ">
          {/* ---------- LEFT SIDE ---------- */}
          ...
          {/* ---------- RIGHT SIDE IMAGE ---------- */}
          <div className="w-full lg:w-[45%] flex justify-center  lg:justify-end mr-28">
