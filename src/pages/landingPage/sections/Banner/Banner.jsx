...
//                 className={`border-b-2 border-gray-300 appearance-none focus:outline-none px-2 py-1 w-32 
...
//               <img
//                 src={grayCircle}
//                 className="absolute top-[150px] -right-20 z-0 opacity-50"
//               />
//               <img
//                 src={yellowShape}
//                 className="absolute top-[132px] -right-16 z-0 h-[40px]"
//               />
//               <img
//                 src={blueCircle}
...
const Banner = () => {
  ...
  return (
    <div className="bg-base-100 py-12 mt-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:gap-20 gap-10 px-20">
          {/* ---------- LEFT SIDE ---------- */}
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <p className="text-[#DAA520] font-bold text-sm sm:text-base">
              100% SATISFACTION GUARANTEE
            </p>

            <div className="my-4 font-bold">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl">Find Your</h1>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl py-4">
                Perfect{" "}
                <span className="inline-flex items-center relative">
                  Tutor
                  <span className="absolute bottom-0 top-6 left-0 w-full hidden sm:block">
                    <svg
                      width="120"
                      height="57"
                      viewBox="0 0 513 57"
            ...
            <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-4">
              ...
              <select
                value={className}
                onChange={(e) => setClassName(e.target.value)}
                className={`border-b-2 border-gray-300 appearance-none focus:outline-none px-2 py-1 w-32 sm:w-36 ${
                  !className ? "text-gray-400" : "text-black"
                }`}
              >
                <option value="" disabled>
              ...
              <button
                onClick={handleSearch}
                className="bg-blue-200 text-blue-700 px-4 py-2 rounded hover:bg-blue-300 shadow"
              >
                Search
              </button>
            </div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <div className="relative max-w-[320px] sm:max-w-[400px] w-full">
              ...
              <img
                src={yellowCircle}
                className="absolute top-[-30px] -right-12 z-0 opacity-50 w-16 sm:w-20"
              />
              <img
                src={blueShape}
                className="absolute top-[-20px] -right-16 z-0 h-[30px] sm:h-[40px]"
              />
              <img
                src={grayCircle}
                className="absolute top-[120px] -right-16 z-0 opacity-50 w-16 sm:w-20"
              />
              <img
                src={yellowShape}
                className="absolute top-[100px] -right-12 z-0 h-[30px] sm:h-[40px]"
              />
              <img
                src={blueCircle}
                className="absolute bottom-[-20px] -left-6 z-0 opacity-50 w-16 sm:w-20"
              />
              <img
                src={wireShape}
                className="absolute bottom-0 -left-12 z-0 h-[15px] sm:h-[20px]"
              />
            </div>
          </div>
        </div>
