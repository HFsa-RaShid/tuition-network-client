      ...
      <div className="  flex flex-col lg:flex-row justify-between items-center container mx-auto pt-16 md:pt-20 pb-10 gap-10 md:gap-16 lg:gap-20 px-6 md:px-10 lg:px-20">
        ...
        <div className="w-full lg:w-1/2 flex justify-center mb-8 lg:mb-0">
          <img
            ...
            className="h-48 sm:h-72 md:h-[420px] lg:h-[480px] object-contain"
          />
        </div>
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 font-medium pt-4">
              Here are some common questions students and tutors ask about
              Tutoria. Hopefully these will clear your confusion!
            </p>
          </div>
          ...
          <div className="join join-vertical w-full">
            ...
            <div className="collapse collapse-arrow join-item border border-t-[#DAA520]">
              ...
              <div className="collapse-content">
                <p className="text-gray-600">
                  Students can post their learning requirements and tutors can
                  apply for those requests. Once a student confirms, the tutor
            ...
            <div className="collapse collapse-arrow join-item border border-t-[#DAA520]">
              ...
              <div className="collapse-content">
                <p className="text-gray-600">
                  Yes! Creating an account and browsing tutors/students is
                  completely free. Some premium features may require a
                  subscription.
                </p>
              </div>
            </div>
            ...
            <div className="collapse collapse-arrow join-item border border-t-[#DAA520]">
              ...
              <div className="collapse-content">
                <p className="text-gray-600">
                  Simply sign up as a tutor, complete your profile with details
                  like education, expertise, and availability, and apply or wait
            ...
            <div className="collapse collapse-arrow join-item border border-t-[#DAA520] border-b-[#DAA520]">
              ...
              <div className="collapse-content">
                <p className="text-gray-600">
                  Tutoria covers a wide range of subjects including school-level
                  courses, university subjects, test preparation, and even
                  skill-based learning like coding, music, and languages.
                </p>
              </div>
            </div>
          </div>
