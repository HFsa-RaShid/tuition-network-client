...
const Reviews = () => {
  ...
  const renderStars = (num) => {
    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <span key={i} className={`text-xl ${i <= num ? "text-yellow-400" : "text-gray-300"}`}>
          ★
        </span>
      );
    }
  ...
  return (
    <div className="bg-white py-16 px-4 md:px-20 container mx-auto">
      ...
      <div className="flex justify-between items-center mb-12 max-w-3xl mx-auto">
        ...
        <button
          className="btn bg-[#DAA520] text-white ml-4"
            ...
            <SwiperSlide key={idx} className="w-72 md:w-80 relative">
              <div className="p-6 bg-gradient-to-br from-[#FFF3CD] to-[#FBE9A6] rounded-3xl shadow-xl h-80 flex flex-col justify-between relative">
                ...
                <div className="text-center">
                  <h3 className="font-bold text-md text-gray-900">{review.name}</h3>
