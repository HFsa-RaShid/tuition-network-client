...
//             <select
//               className="w-full border border-white/20 p-2 rounded bg-[#111C27] mb-3"
//               value={selectedCity}
//               onChange={(e) => {
...
//               <li className="p-4 pb-2 text-xs opacity-60 tracking-wide text-black bg-base-100">
...
//                   <li
//                     key={tutor._id}
//                     className="flex items-center justify-between gap-4 px-4 py-3 hover:bg-[#29313f] transition rounded-md border-b border-gray-300"
//                   >
