...
//     <div>
//       <Navbar></Navbar>
//       <div className="bg-[#170F24] min-h-screen">
//         <div className="flex p-6 gap-6 container mx-auto">
//           {/* Left Side - Profile Card */}
//           <div className="w-[28%] mt-20 text-white rounded-xl p-4 flex flex-col items-center bg-[#111824] border border-white/20 
//               relative">
...
//               }
//               alt={tutor.name}
//               className="w-32 h-32 rounded-lg border mx-auto bg-slate-300"
//             />
...
//           {/* Middle Section - Tabs */}
//           <div className="w-[52%] mt-20  rounded-xl p-4 bg-[#111824]  border border-white/20 overflow-hidden group transition-all duration-700 
...
//           <div className="w-[25%] mt-20 border border-white/20 bg-[#111824] text-white shadow-md rounded-xl p-4">
//           <div className="absolute top-[-50%] left-1/2 -translate-x-1/2 w-[120%] h-[200%]
//                                 opacity-50 group-hover:opacity-0 transition-opacity duration-700
//                                 [background:radial-gradient(ellipse_at_top,rgba(0,255,255,0.35)_0%,rgba(0,255,255,0.05)_40%,transparent_70%)]
//                                 blur-[30px] rotate-[6deg] pointer-events-none"></div>
...
//                 <input
//                   type="text"
//                   className="input bg-[#111824] border border-white/20 w-full"
...
//                 <input
//                   type="tel"
//                   className="input w-full bg-[#111824] border border-white/20"
...
//                 <textarea
//                   className="textarea bg-[#111824] border border-white/20 w-full min-h-[160px]"
...
//                 ></textarea>
//               </div>
// {/* <GlassButton text="Submit & Pay" type="submit"  /> */}
//               <button
//                 type="submit"
