...
//           {/* Left Panel */}
//           <div className="w-[40%] p-4 overflow-y-auto border-r border-gray-200">
...
//                 className="p-6 relative rounded-xl text-white border border-white/20 bg-[#111824] py-8 overflow-hidden group transition-all duration-700 
...
//           {/* Right Map Panel */}
//           <div className="w-[60%] h-[500px] m-4 relative z-0">
//             <MapContainer
