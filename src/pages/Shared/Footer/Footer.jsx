...
const Footer = () => {
  return (
    <footer className=" bg-slate-100 text-base-content px-10 pt-10 pb-6 rounded-t-3xl border-t-4">
        ...
        <form>
          ...
          <fieldset className="form-control w-80">
            ...
            <div className="join">
              ...
              />
              <button className="bg-[#f9d045] px-4 join-item font-semibold">Subscribe</button>
            </div>
          </fieldset>
          <div className="mt-4 flex space-x-4">
            <a href="#" className="text-2xl text-[#0065ff] opacity-80">
              <svg
