const heroImages = {
  ...
  class8:
    "https://images.unsplash.com/photo-1509062522311-a26b83a21a1d?auto=format&fit=crop&w=1600&q=80",
  class9:
    "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=1600&q=80",
  class10:
    "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=1600&q=80",
    ...
    classes: [
      {
        ...
        name: "Class 6",
        shortDescription: "Junior secondary তে গতি আনার জন্য কনসেপ্ট-ফোকাসড কোচিং।",
      ...
      },
      {
        ...
        name: "Class 7",
        shortDescription: "Chapter-wise mastery, weekly assessment ও parental feedback রিপোর্ট।",
      ...
      },
      {
        ...
        name: "Class 8",
        shortDescription: "JSC সমমানের জন্য analytical problem solving ও concept drills।",
      ...
      },
      {
        ...
        name: "Class 9",
        shortDescription: "SSC প্রস্তুতির জন্য বিষদ science/commerce/humanities mentorship।",
        subjects: [
          "Bangla",
          "English",
          "Physics",
      ...
      },
      {
        ...
        subjects: ["Bangla", "English", "Physics", "Chemistry", "Biology", "Math"],
  ...
  },
  {
    ...
    classes: [
      ...
      },
      {
        ...
        name: "Class 8",
        shortDescription: "Weekly lab report, viva prep এবং structured study plan।",
      ...
      },
      {
        ...
        name: "Class 9",
        shortDescription: "Science/Business Studies/Humanities সব গ্রুপেই mentor pool।",
        subjects: ["Bangla", "English", "Physics", "Chemistry", "Biology", "Economics"],
        heroImage: heroImages.class9,
      },
      {
        id: attachId("Class 10 EV", "class-10-ev"),
        name: "Class 10",
        shortDescription: "Board question breakdown, timer-based mocks ও skill report।",
        subjects: ["Bangla", "English", "Physics", "Chemistry", "Biology", "Accounting"],
        heroImage: heroImages.class10,
      },
    ],
  },
    ...
    classes: [
      {
        ...
        shortDescription: "Lower secondary checkpoint prep with skills rubrics।",
      ...
      },
      {
        id: attachId("O Level"),
        name: "O Level",
        shortDescription: "Core, Extended ও Additional syllabuses সহ grade boost plan।",
      ...
      },
      {
        ...
        subjects: ["Physics", "Chemistry", "Biology", "Math", "Business Studies"],
    ...
    classes: [
      {
        ...
        name: "Dakhil",
        shortDescription: "Hadith ও Tafsir ক্লাসের পাশাপাশি Science ও Commerce বিষয়ের গাইডেন্স।",
      ...
      },
      {
        ...
        name: "Alim",
        shortDescription: "ফিকহ, আরবি সাহিত্য, দর্শন ও আধুনিক বিষয়ে সমন্বিত কোচিং।",
...
export const classDetails = {
  ...
  "class-10-ev": detailBuilder("Class 10 (English Version)", heroImages.class10),
