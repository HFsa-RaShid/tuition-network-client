  ...
  return (
    <div className="flex h-screen transition-all duration-300">
      ...
      >
        ...
        <NavLink
            to="/parentDashBoard/dashBoard"
            className={({ isActive }) => isActive ? "bg-yellow-500 p-2 rounded-lg flex items-center space-x-3" : "p-3 rounded-lg flex items-center space-x-3"}
          >
            <FaUser />
          ...
          <NavLink
            ...
            className={({ isActive }) => isActive ? "bg-yellow-500 p-2 rounded-lg flex items-center space-x-3 text-black" : "p-3 rounded-lg flex items-center space-x-3"}
          >
            <FaUser />
